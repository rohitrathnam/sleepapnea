function [outputs, labels] = eeg(filename)
index = 3; % EEG
...
outputs = [Mn; Md; Rdt; Rda; Rdb; Rdg; Rta; Rtb; Rtg; Rab; Rag; Rbg; delta; theta; alpha; beta; gamma]';
labels = {'Mn', 'Md', 'Rdt', 'Rda', 'Rdb', 'Rdg', 'Rta', 'Rtb', 'Rtg', 'Rab', 'Rag', 'Rbg', 'delta', 'theta', 'alpha', 'beta', 'gamma'};
